$.fn.dataTableExt.oPagination.input = {
    "fnInit": function ( oSettings, nPaging, fnCallbackDraw )
    {
        ...
        nFirst.className = "btn btn-default btn-md paginate_button first disabled";
        nPrevious.className = "btn btn-default btn-md paginate_button previous disabled";
        nNext.className="btn btn-default btn-md paginate_button next";
        nLast.className = "btn btn-default btn-md paginate_button last";
