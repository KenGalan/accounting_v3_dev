$(document).ready(function(){
    ...
    $('#reportMrpBtn').on("click", function(){
      window.open('ajax/mrp_reports/reports/mrp_report.php', '_blank');
    });
      ...
      function(isConfirm){
            ...
            if (isConfirm){
              ...
              $.ajax({
                ...
                //url: "ajax/mrp_reports/insert/try.php",
                ...
                success: function(response){
                  ...
                  if(response == 1){
                    ...
                    swal({
                      ...
                      text: "", 
                      type: "success",
                      confirmButtonClass: 'btnSwalSuccess'},
                      function(isConfirm1){
                        if(isConfirm1){
                          //setTimeout(loader, 275);
                          loader();
                        }
                      });
  ...
  function start(){
    ...
    //var imResponseData = getImData();
    //var osResponseData = getOsData();
    var imResponseData = [];
    var osResponseData = [];

    getMrpDataTable("all_Table", responseData);

    $('a[class="mrp-tab"]').on("click", function(e){
      $("div#divCardId").waitMe({effect : 'pulse', text : 'Loading...'});
    });
    ...
    $('a[class="mrp-tab"]').on('shown.bs.tab', function (e) {
      ...
      // return false;
            ...
            $(activeTabTables).each(function(){
              ...
              else if(findValue === 'BUY'){
                var filter = {
                  REORDER_DATE: 'IMMEDIATE',
                  //INV_DATE_DEPT: 'IMMEDIATE',
              ...
              else if(findValue === 'QSTOCKS'){
                var data = responseData.filter(function (item) {
                    mtl = item.SEGMENT1;
                    subStringMtl = mtl.substring(0, 5);
                    return subStringMtl.toUpperCase() === 'TPC.Q';
                });
                getMrpDataTable(activeInnerTblId, data);
              }
              else{
  ...
  function getMrpData(){
    ...
    $.ajax({
        ...
        type: "POST",
        dataType: "json",
        url: "ajax/mrp_reports/select/select_mrp.php", 
        success: function(response){
         ...
         var table = $('#'+tableId).DataTable({
            ...
            "columns":[
                ...
                { "data": "SEGMENT1", render: function ( data,type,row ){
                  ...
                  return "<span class='hover-desc'>"+"<a style='cursor:pointer'>"+subStringSegment1+"</a>"+"<span class='hover-desc-text'>"+data+"</span></span>"
                } },
                ...
                { "data": "OPEN_PO", render: function ( data,type,row ){
                ...
                { "data": "COLOR_REMARKS", render: function(data,type,row){
                  if(data == "" || data ==  null){
                    return "---";
                  }
                  else{
            ...
            "createdRow":function ( row, data, index ) {
              ...
              if(color!=null){
                ...
                if (((parseInt(colorRgb['r'])*0.299) + (parseInt(colorRgb['g'])*0.587) + (parseInt(colorRgb['b'])*0.114)) > 186){
                  $(row).css({background: color, color: '#000000'});
                }
                else{
                  $(row).css({background: color, color: '#ffffff'});
                }
                ...
                if(grossData.length != 0){
                  var clickedColInfoTable = $('#clickedColInfoTable').DataTable({
                    ...
                    "columns":[
                        ...
                        { "data": "FORECAST_QTY", render: function ( data,type,row ){
                          return numberWithCommas(data);
                        } },
            ...
            success: function(response){
              ...
              if(header.length != 0 && body.length != 0){
                ...
                $(body).each(function(){
                  ...
                  bodyString += "<td class='dt-body-right'>"+numberWithCommas(self)+"</td>";
                });
