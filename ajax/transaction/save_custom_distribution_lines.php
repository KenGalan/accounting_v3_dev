...
/*
    Optional:
    remove old lines first for this move_id if you want a fresh save each time.
    If m_acc_cust_dist_line has no move_id column, skip this delete.
*/
...
";
pg_query_params($conn, $delete_sql, array($move_id));
*/
