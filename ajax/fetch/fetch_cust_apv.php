...
// $yearMonth = '2026-02';
$q = "	  
select distinct AM.NAME journal_entry,am.ref reference, am.amount_total, am.date accounting_date, am.state status, am.id am_id, cd.from_date, cd.to_date from
account_move am
