...
--     ADJT.ITEM_LABEL,
    ...
    END AS CREDIT,
    ACDR.YEAR_MONTH
FROM M_ACC_DATE_RANGE ACDR
-- JOIN M_ACC_DIST_JOURNAL_ENTRIES ADJE ON ACDR.ID = ADJE.DATE_RANGE_ID
-- JOIN M_ACC_DIST_JOURNAL_ITEMS ADJT ON ADJE.ID = ADJT.MAIN_ID
join M_ACC_ACCRUAL maa on maa.date_range_id = ACDR.ID
