...
<style>
    ...
    #distTable td:nth-child(4) select {
    width: 100% !important;
    max-width: 350px;
    }
    #distTable td:nth-child(5) select {
    width: 100% !important;
    max-width: 200px;
    }
    #addAccrualTbl td:nth-child(1) select {
    width: 100% !important;
    max-width: 350px;
    }
    /* .totalVal{
                    ...
                    // },

                        {
                            ...
                            render: function(row) {
                                ...
                                html += `<select class="journalAccTemp journalAccount" disabled>`;
